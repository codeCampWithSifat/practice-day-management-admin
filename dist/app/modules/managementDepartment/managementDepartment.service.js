...
const createManagementDepartment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const createDepartment = yield managementDepartment_model_1.ManagementDepartment.create(payload);
    if (!createDepartment) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed To Create Department');
    }
...
const updateManagementDepartment = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield managementDepartment_model_1.ManagementDepartment.findByIdAndUpdate({ _id: id }, payload, { new: true });
    return result;
});
const getAllManagementDepartments = (paginationOptions, filters) => __awaiter(void 0, void 0, void 0, function* () {
